...
import AnimatedFigure from "@/_components/AnimatedFigure";
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4 max-w-3xl mx-auto">
            ...
            <p className="text-base text-muted-foreground leading-relaxed">
              From technical deep-dives and system design insights to practical coding tutorials and career advice, 
              I share my journey of continuous learning in the ever-evolving world of technology. Whether you&apos;re 
              a seasoned developer or just starting out, there&apos;s something for everyone looking to grow their 
              engineering skills and build amazing products.
            </p>
            <div className="flex flex-wrap justify-center gap-2 pt-2">
              <span className="px-3 py-1 rounded-full bg-primary/10 text-primary text-sm font-medium">System Design</span>
              <span className="px-3 py-1 rounded-full bg-secondary/10 text-secondary text-sm font-medium">Backend Development</span>
              <span className="px-3 py-1 rounded-full bg-primary/10 text-primary text-sm font-medium">Performance Optimization</span>
              <span className="px-3 py-1 rounded-full bg-secondary/10 text-secondary text-sm font-medium">Career Growth</span>
            </div>
          </div>
        </div>
        <Link
      ...
      <section className="space-y-12">
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            Let&apos;s connect and share ideas about engineering, travelling, trekking, and fitness.
          </p>
        </div>
        
        {/* Main Content - Centered and Balanced */}
        <div className="max-w-6xl mx-auto">
          {/* Animated Figure - Centered */}
          <div className="flex justify-center mb-12">
            <div className="w-full max-w-2xl aspect-[16/9] rounded-2xl overflow-hidden shadow-2xl bg-gradient-to-br from-primary/5 to-secondary/5 border border-border/50">
              <AnimatedFigure />
            </div>
          </div>
          
          {/* Social Links - Centered Grid */}
          <div className="flex justify-center">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 w-full max-w-2xl">
              <a
                ...
                className="group flex flex-col items-center gap-3 p-6 rounded-xl border border-border bg-background hover:bg-accent hover:border-primary/20 transition-all duration-300 shadow-sm hover:shadow-lg hover:-translate-y-1"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group flex flex-col items-center gap-3 p-6 rounded-xl border border-border bg-background hover:bg-accent hover:border-secondary/20 transition-all duration-300 shadow-sm hover:shadow-lg hover:-translate-y-1"
              >
